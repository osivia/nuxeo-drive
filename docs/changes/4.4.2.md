...
- [NXDRIVE-1910](https://jira.nuxeo.com/browse/NXDRIVE-1910): [Direct Transfer] Allow the feature when the application is paused
...
- [NXDRIVE-2006](https://jira.nuxeo.com/browse/NXDRIVE-2006): [Direct Transfer] Isolate the component
...
- [NXDRIVE-2029](https://jira.nuxeo.com/browse/NXDRIVE-2029): [Direct Transfer] Allow the feature when the synchronization is disabled
